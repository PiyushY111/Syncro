...
export default function SettingsPage() {
    ...
    return (
        <div className="space-y-6 max-w-4xl mx-auto">
            ...
            {/* Tabs */}
            <div className="flex border-b border-gray-200 dark:border-zinc-800 gap-4 text-left">
                <button
                    onClick={() => settings.setActiveTab('profile')}
                    className={`flex items-center gap-2 pb-3 px-1 text-sm font-medium border-b-2 transition-all cursor-pointer ${
