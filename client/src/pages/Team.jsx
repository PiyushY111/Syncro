...
import { UsersIcon, Search, UserPlus, Shield, Activity, Trash2, LogOut } from "lucide-react";
                    ...
                    <div className="max-w-4xl w-full">
                                            ...
                                            <td className="px-6 py-2.5 whitespace-nowrap text-right text-sm">
                                                {user.user.id === currentUser?.id ? (
                                                    currentWorkspace?.ownerId !== currentUser?.id && (
                                                        <button
                                                            onClick={() => handleRemoveMember(user.id, user.user?.name, true)}
                                                    ...
                                                    canEditMember(user) && (
                                                        <button
                                                            onClick={() => handleRemoveMember(user.id, user.user?.name, false)}
                                                            className="text-gray-400 hover:text-red-500 transition-colors p-1"
                                                            title="Remove Member"
                                                        >
                                                            <Trash2 size={16} />
                        ...
                        <div className="sm:hidden space-y-3">
                            {filteredUsers.map((user) => (
                                <div
                                    key={user.id}
                                    className="p-4 border border-gray-200 dark:border-zinc-800 rounded-md bg-white dark:bg-zinc-900 flex justify-between items-center"
                                >
